...
class ProfileWindow(QMainWindow):
    def __init__(self, user_data, parent=None):
        ...
        self.setGeometry(200, 100, 1000, 800)  # x, y, width, height
        self.init_ui()
    ...
    def create_experience_tab(self):
        ...
        self.skills.setMaximumHeight(60)
        ...
        try:
            ...
            try:
                ...
                QMessageBox.information(self, "Success",
                                        "✅ Account created successfully!\n\nClick 'My Profile' to complete your professional details.")
                self.clear_inputs()
                self.update_ui_state()
    ...
    def login(self):
        ...
        try:
            ...
            QMessageBox.information(self, "Login Success",
                                    f"Welcome back, {email}!\n\nClick 'My Profile' to view or update your professional details.")
            self.clear_inputs()
            self.update_ui_state()
        ...
        try:
            ...
            if users.val():
                ...
                for uid, user_data in users.val().items():
                    profile_status = "✅ Complete" if user_data.get('profile_complete') else "❌ Incomplete"
                    self.log_db_operation(f"   👤 {user_data.get('email', 'No email')} - Profile: {profile_status}")
            else:
